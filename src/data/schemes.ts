...
export const schemesData: Scheme[] = [
  {
    ...
    comments: [
      { name: 'Ramesh Kumar', text: 'Great initiative! Making services accessible is key.', time: '2024-09-20T10:30:00Z', sentiment: 'positive' },
      { name: 'Priya Sharma', text: 'The internet speed in my village has improved a lot.', time: '2024-09-21T14:15:00Z', sentiment: 'positive' }
    ]
  },
  {
    id: 2,
    ...
    comments: [
      { name: 'Ankit Jain', text: 'This has boosted local manufacturing. We need more focus on quality control.', time: '2024-09-19T16:45:00Z', sentiment: 'positive' }
    ]
  },
  {
    id: 3,
    ...
    comments: [
      { name: 'Sunita Devi', text: 'My city is much cleaner now. Public participation is very important.', time: '2024-09-18T09:20:00Z', sentiment: 'positive' },
      { name: 'Vijay Singh', text: 'Waste segregation needs to be implemented more strictly.', time: '2024-09-20T11:30:00Z', sentiment: 'negative' }
    ]
  },
  {
    id: 4,
  ...
  },
  {
    ...
    comments: [
      { name: 'Aarav Patel', text: 'I got a job after completing a course under this mission!', time: '2024-09-17T13:45:00Z', sentiment: 'positive' }
    ]
  },
  {
    id: 6,
